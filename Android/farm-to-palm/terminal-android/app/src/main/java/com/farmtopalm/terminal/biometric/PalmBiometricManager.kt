...
interface PalmBiometricManager {
    ...
    /** Capture for enrollment; runs asynchronously and invokes [callback] on completion. [onHint] receives live SDK hints during capture for guided UX. */
    fun captureForEnroll(scope: CoroutineScope, hand: String, callback: (Result<CaptureResult>) -> Unit, onHint: ((String) -> Unit)? = null)
